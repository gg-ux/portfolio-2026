...
export const resumeTemplateOverrides = {
  ...
  'anthropic': {
    ...
    experienceOverrides: {
      ...
      'Tesla': [
        'Shipped AI chatbot that boosted sales lead conversion by 120%, designing conversational UI that builds trust',
        'Led global launch of responsive product pages for Tesla.com, iterating quickly based on user feedback',
        'Contributed to Tesla Design System with component guidelines, elevating craft while maintaining shipping velocity',
        'Designed enterprise apps for Energy Installers and advisors, handling complex workflows across iOS/Android',
      ],
      'Accurate Background': [
        'Designed complex compliance workflows for enterprise platform, making intricate processes feel intuitive',
        'Collaborated cross-functionally with engineering teams to ship platform improvements in ambiguous environment',
      ],
      'INDI EV': [
